...
public class LibrarySystem{
    ...
    /**
     * Borrow function that allows user to check out book and updates the library system
     * @param user: user that is borrowing book
     * @param book: book that is being borrowed
     * Returns boolean that indicates if checkout was successful
     */
     ...
     * Returns boolean that signifies that book return was successful
     */
     ...
     * Returns boolean that shows if search was successful or not
     */
